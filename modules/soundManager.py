...
class SoundManager(object):
   ...
   class _SM(object):
      ...
      _MUSIC_FOLDER = os.path.join("sounds")
      _SFX_FOLDER = os.path.join("sounds")
      
      _FOLDER = {
         "bludgeoning_damage.wav"     : _SFX_FOLDER,
         "fire_damage.wav": _SFX_FOLDER,
         "fire_damage.wav": _SFX_FOLDER,
         "holy_damage.wav": _SFX_FOLDER,
         "level_up_jingle.wav": _SFX_FOLDER,
         "necrotic_damage.wav": _SFX_FOLDER,
         "piercing_damage.wav": _SFX_FOLDER,
         "slashing_damage.wav": _SFX_FOLDER,
         "spellcast.wav": _SFX_FOLDER,
         "death.wav": _SFX_FOLDER,
         "PLACEHOLDER.mp3" : _MUSIC_FOLDER
      }
